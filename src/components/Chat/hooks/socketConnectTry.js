// KOKOB CREATED THIS FILE

import { useEffect } from 'react'; 
import { onlineFriends, onlineFriend, offlineFriend, fetchChats, receivedMessage, senderTyping, createChat, addUserToGroup, leaveCurrentChat, deleteCurrentChat } from '../../../store/actions/chat'
...
function useSocketTry (user, dispatch, socket){ 

    useEffect(() => { 
        dispatch(fetchChats()) // A
            .then( r => { 
                console.log('socket before join', socket, user)
